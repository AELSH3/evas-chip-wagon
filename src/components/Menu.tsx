                    ...
                    >
                      <div className="flex items-baseline gap-2">
                        ...
                        {"tag" in item && item.tag && (
                          <span className="shrink-0 rounded-full bg-brand-cream px-2.5 py-0.5 text-[11px] font-semibold text-brand-red">
                            {item.tag}
                          </span>
                        )}
                        <span className="flex-1 border-b border-dotted border-brand-charcoal/20" />
                        <span className="shrink-0 font-body text-base font-semibold text-brand-green">
                          {item.price}
                        </span>
                      </div>
